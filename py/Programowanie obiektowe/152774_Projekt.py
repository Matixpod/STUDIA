...
if __name__ == "__main__":
    zarobek_1 = Income(690, "Przelewik", "wypłata", "Blik")
    zarobek_2 = Income(610, "Przelewik", "wypłata", "Blik")
    zarobek_3 = Income(730, "Przelewik", "wypłata", "Blik")
    zarobek_4 = Income(830, "Przelewik", "wypłata", "Blik")
    zarobek_5 = Income(920, "Przelewik", "wypłata", "Blik")
    zarobek_6 = Income(1200, "Przelewik", "wypłata", "Blik")

    wydatek_1 = Expense(591, "kfc", "jedzenie", "Blik")
    wydatek_2 = Expense(123, "kfc", "jedzenie", "Blik")
    wydatek_3 = Expense(532, "kfc", "jedzenie", "Blik")
    wydatek_4 = Expense(100, "kfc", "jedzenie", "Blik")
    wydatek_5 = Expense(234, "kfc", "jedzenie", "Blik")
    wydatek_6 = Expense(123, "kfc", "jedzenie", "Blik")
